    ...
    <div class="bg-black bg-opacity-60 min-h-screen flex items-center justify-center">
        ...
        <div class="container mx-auto px-6 flex justify-center lg:justify-end">
            <div class="bg-gray-900 bg-opacity-85 backdrop-blur-md p-10 rounded-3xl shadow-2xl w-full max-w-md border border-green-500/30">
                ...
                <form method="POST" action="/mealbox/public/?url=login" class="space-y-4">

                    <input type="email" name="email" placeholder="Email" required
                        class="input-dark w-full px-4 py-3 border border-gray-700 rounded-lg bg-gray-800 text-gray-200 focus:ring-2 focus:ring-green-400 outline-none transition">
                ...
                <p class="text-center mt-6 text-sm text-gray-300">
                    ...
                    <a href="/mealbox/public/?url=register" class="text-green-400 font-semibold hover:underline">
                        Create one
                    </a>
                </p>
            </div>
...
<!-- Autofill Fix -->
<style>
/* Keep inputs dark even when autofilled */
...
.input-dark:-webkit-autofill:focus {
  ...
  -webkit-text-fill-color: #e5e7eb !important; /* Tailwind text-gray-200 */
